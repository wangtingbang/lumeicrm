...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<ss:Worksheet ss:Name="sheet1">
		<Table ss:StyleID="ta1">
			...
			<Row ss:Height="12.8126">
				...
				<Cell ss:StyleID="ce1">
					<Data ss:Type="String">Car Info</Data>
				</Cell>
				<Cell ss:StyleID="ce1">
					<Data ss:Type="String">New/Used</Data>
				</Cell>
				<Cell ss:StyleID="ce1">
					<Data ss:Type="String">Car Sale Status</Data>
				</Cell>
				<Cell ss:StyleID="ce1">
					<Data ss:Type="String">Status Date</Data>
				</Cell>
				<Cell ss:StyleID="ce1">
					<Data ss:Type="String">Modified Date</Data>
				</Cell>
			</Row>
  ...
  <#list result as obj>
			<Row ss:Height="12.8126">
				...
				<Cell ss:StyleID="ce1">
					<Data ss:Type="String">${obj.sourceString!''}</Data>
				</Cell>
				<Cell ss:StyleID="ce1">
					<Data ss:Type="String">${obj.remark!''}</Data>
				</Cell>
				<Cell ss:StyleID="ce1">
					<Data ss:Type="String">${obj.years!''}/${obj.model!''}</Data>
				</Cell>
				<Cell ss:StyleID="ce1">
					<Data ss:Type="String"><#if obj.isNew == 1>New</#if><#if obj.isNew == 2>Used</#if></Data>
				</Cell>
				<Cell ss:StyleID="ce1">
					<Data ss:Type="String">${obj.dealStatusString!''}</Data>
				</Cell>
				<Cell ss:StyleID="ce1">
					<Data ss:Type="String">${(obj.dealDate?string("yyyy-MM-dd"))!''}</Data>
				</Cell>
				<Cell ss:StyleID="ce1">
					<Data ss:Type="String">${(obj.updateTime?string("yyyy-MM-dd"))!''}</Data>
				</Cell>
			</Row>
  </#list>
