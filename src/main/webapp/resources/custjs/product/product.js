	...
	function createSubmit(){
		$.imodal({
			...
			contents:function(){
				...
				var data = {amateurDisp:1, investmentDisp:1, productType:1,dueTimeType:1, valueDateType:0,advanceOffline:1 };
				var data = $.extend({},data,{datadic:{productType:datadicArray(datadic["productType"]),incomeDistributionMode:datadicArray(datadic["incomeDistributionMode"]),institution: datadicArray(datadic["institution"])}});
				return pagefn({
					title:'新增产品',
					page1:pagefn1(data),
					page2:pagefn2({}),
