			...
			function(data){
				$.imodal({
					...
					contents:function(){
						...
						var data1 = $.extend({},data.prdRuProduct,{readonly:true,datadic:{productType:datadicArray(datadic["productType"]),incomeDistributionMode:datadicArray(datadic["incomeDistributionMode"]),institution: datadicArray(datadic["institution"])}});
